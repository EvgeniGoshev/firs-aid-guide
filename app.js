...
const translations = {
  en: {
    ...
    academyEyebrow: "First aid community", academyTitle: "Responder Academy", academyDescription: "Compete, collect achievements, join live practice, and use trusted learning resources.", learner: "Learner", leaderboard: "Leaderboard", achievements: "Achievements", certificate: "Certificate", certificateDescription: "Complete 10 lessons and score at least 80% to earn an in-platform First Aid Foundations training certificate.", certificateDisclaimer: "Training recognition only — it is not an accredited medical qualification and does not replace a certified first-aid course.", checkEligibility: "Check eligibility", liveRoom: "Live Training Room", offline: "Offline", liveRoomDescription: "Join an instructor-led scenario and see updates in real time.", join: "Join", resourceLibrary: "Resource Library", smartCoach: "Smart Coach Search", smartSearch: "Smart search", smartCoachDescription: "Search lessons and academy content by topic, symptom, or action.", search: "Search", academyFeed: "Academy Feed",
    ...
    certificateTitle: "Training Certificate of Achievement", certifiesThat: "This certifies that", completedRequirements: "has successfully completed the requirements for", printCertificate: "Print / Save as PDF", emailPlaceholder: "you@example.com", passwordPlaceholder: "Minimum 8 characters", namePlaceholder: "Your name"
  },
  bg: {
    ...
    certificateTitle: "Обучителен сертификат за постижение", certifiesThat: "С настоящото се удостоверява, че", completedRequirements: "успешно изпълни изискванията за", printCertificate: "Печат / Запази като PDF", emailPlaceholder: "твоят@имейл.bg", passwordPlaceholder: "Минимум 8 символа", namePlaceholder: "Твоето име"
  }
};
